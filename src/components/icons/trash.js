...
function TrashIcon({ size, fill, onClick }) {
  return (
    <Wrapper onClick={onClick} styling={{ padding: "0" }}>
      <svg
        height={`${size}pt`}
